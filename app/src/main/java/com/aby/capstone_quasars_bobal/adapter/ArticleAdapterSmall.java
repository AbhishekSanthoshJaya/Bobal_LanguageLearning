...
public class ArticleAdapterSmall extends RecyclerView.Adapter<ArticleAdapterSmall.ArticleViewHolder> implements Filterable {
    ...
    public ArticleAdapterSmall(Context context, ArrayList<Article> articles, RequestQueue requestQueue, OnArticleListener onArticleListener){
    ...
    public ArticleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(context).inflate(R.layout.article_item_small, parent, false);
